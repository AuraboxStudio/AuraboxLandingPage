    ...
    <section className="py-24 w-full bg-[#DFE5E5]">
      <div className="max-w-[1341px] mx-auto px-4 flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="w-full lg:w-1/2 text-center">
          <h2 className="text-[40px] md:text-[48px] font-['Bebas_Neue_Pro-Bold'] text-[#002432] leading-tight mb-10">
            QUANDO CONTRATAR <br /> <span className="text-[#f78837]">UMA AGÊNCIA?</span>
          </h2>
            ...
            {benefitCards.map((card, index) => (
              ...
              >
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-2xl font-['Bebas_Neue_Pro-Bold'] mb-2">{card.highlight}</p>
                  <p className="text-sm font-['Schibsted_Grotesk-Medium'] opacity-90">
                    {card.description}
                  </p>
                </CardContent>
              </Card>
