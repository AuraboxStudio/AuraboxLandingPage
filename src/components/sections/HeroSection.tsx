    ...
    <section className="py-20 w-full relative">
      <div className="max-w-[1341px] mx-auto px-4 flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div className="flex-1 space-y-6">
          <h1 className="text-[48px] md:text-[64px] font-bold leading-[0.9] font-['Bebas_Neue_Pro-Bold'] text-[#002432]">
            SOLUÇÕES FORA DA CAIXA<br />
            PARA O <span className="text-[#f78837]">SEU NEGÓCIO</span>
          </h1>

          <p className="text-xl font-['Schibsted_Grotesk-Bold'] text-[#002432] max-w-[500px]">
          ...
          <div className="flex gap-6 pt-6 max-w-[520px]">
            <div className="text-center">
              ...
              <p className="text-sm text-[#002432] opacity-80">das decisões começam online</p>
            </div>
            <div className="text-center">
              <p className="text-2xl text-[#002432] font-bold">2.8x</p>
              <p className="text-sm text-[#002432] opacity-80">mais crescimento com agências</p>
            </div>
            <div className="text-center">
              <p className="text-2xl text-[#002432] font-bold">45%</p>
              <p className="text-sm text-[#002432] opacity-80">redução em CAC</p>
            </div>
          </div>
        </div>
