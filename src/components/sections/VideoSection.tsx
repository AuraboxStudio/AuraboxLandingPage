    ...
    <section className="py-24 bg-white font-sans">
      <div className="max-w-[1200px] mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-[40px] lg:text-[48px] font-bold text-[#002432] leading-tight">
        ...
        <div className="bg-[#f8f9fa] rounded-[30px] p-10">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-3">
              ...
              <h3 className="text-[36px] lg:text-[42px] text-[#002432] font-bold">
                PERGUNTAS FREQUENTES
              </h3>
              <MessageCircle className="w-6 h-6 text-[#f78837]" />
            </div>
            <p className="text-[#002432] opacity-70 text-lg mt-2 font-medium">
            ...
            {faqItems.map((item, index) => (
              ...
              >
                ...
                <AccordionContent className="px-6 pb-5 pt-0 border-t border-gray-100">
                  <p className="text-[#002432] text-base opacity-80">{item.answer}</p>
                </AccordionContent>
              </AccordionItem>
            ))}
          </Accordion>
